 ...
 */
public class ZonaCargaS6 {

    private final BlockingQueue<PedidoS6> pedidosPendientes;

    /**
     * Inicializa la zona de carga con una capacidad fija.
     * @param capacidad cantidad de pedidos que soporta la zona.
     */
    public ZonaCargaS6(int capacidad) {
    ...
    public BlockingQueue<PedidoS6> getPedidosPendientes() {
     ...
     */
    public synchronized PedidoS6 retirarPedido(){
